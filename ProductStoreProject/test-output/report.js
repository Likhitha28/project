$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("D:/eclipse partice/ProductStoreProject/src/main/java/feature/productstore.feature");
formatter.feature({
  "line": 2,
...
formatter.step({
  "line": 9,
  "name": "The user login using \"prem\" and \"prem\" with vaild and invaild deatils",
  "matchedColumns": [
    0,
    1
  ],
...
formatter.step({
  "line": 9,
  "name": "The user login using \"\" and \"123456\" with vaild and invaild deatils",
  "matchedColumns": [
    0,
    1
  ],
